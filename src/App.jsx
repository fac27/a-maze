...
function App() {
    ...
    function movePlayer() {
        const handleKeyDown = (e) => {
            ...
            const keyMap = {
                ArrowUp: { row: position.row--, column: position.column },
                ArrowDown: { row: position.row++, column: position.column },
                ArrowLeft: { row: position.row, column: position.column-- },
                ArrowRight: { row: position.row, column: position.column++ },
            }
